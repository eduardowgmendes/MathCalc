...
package br.com.edu.application.mathcalc;
...
public class AlertDialogFragment extends DialogFragment implements DialogInterface.OnClickListener {
    ...
    public static void showMessageDialog(Activity activity, CharSequence message,
                                         CharSequence positiveButtonLabel) {
    ...
    public void onClick(DialogInterface dialog, int which) {
        ...
        if (activity instanceof OnClickListener /* always true */) {
            ((OnClickListener) activity).onClick(this, which);
        }
    }
}
